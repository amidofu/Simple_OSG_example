...
### Main Install dir
# OSG_ANDROID_DIR	:= path to where your OSG installed: e.g. /home/usr/OpenSceneGraph-3.0.1/osginstall
...
### Add all source file names to be included in lib separated by a white space
LOCAL_SRC_FILES := osgMain.cpp NativeLib.cpp TestCallback.cpp
#link the libs, now just link all
